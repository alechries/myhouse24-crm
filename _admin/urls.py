...
urlpatterns = [
    ...
    path('account/export/xls', views.export_account_xls_view, name='admin_export_account_xls'),
    ...
    path('tariffs/copy/<int:pk>', views.tariffs_copy_view, name='admin_tariffs-copy'),
